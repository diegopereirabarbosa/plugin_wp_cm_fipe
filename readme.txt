...
O plugin faz a consulta na API parallelum.com.br  via HTTP REST, consumindo os dados da tabela Fipe, que são atualizados diariamente sem precisar que o usuário faça nada.
Link do serviço: https://parallelum.com.br/fipe/api/v1/carros/marcas 
