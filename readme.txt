...
O plugin faz a consulta na API //parallelum.com.br/fipe/api/v1  via HTTP REST, consumindo os dados da tabela Fipe, que são atualizados diariamente sem precisar que o usuário faça atualização em seu site.
