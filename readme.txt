...
===== Descrição =====
O plugin CM Fipe realiza pesquisa na API da tabela Fipe de veículos do Brasil, e não precisa criar tabelas no banco de dados na sua instalação wordpress, deixando seu site mais rápido com uso de requisições via Ajax. O plugin não tem cria link de entrada ou saída no seu wordpress, todas as requisições via API não compromete a segurança do seu site.
